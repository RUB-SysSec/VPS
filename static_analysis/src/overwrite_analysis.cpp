...
#if DEBUG_PRINT_ICALL_RESOLUTION
                cout << "Indirect call resolving: " << "\n";
                cout << "BB: " << hex << block.get_address() << "\n";
                cout << "Before: " << *icall_target << "\n";
                cout << "Base: " << *base << "\n";
                cout << "Entry Offset: " << hex << entry_offset << "\n";
#endif
